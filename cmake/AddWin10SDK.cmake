macro(add_window10_sdk)
    ...
    if (NOT DEFINED ${CMAKE_SYSTEM_VERSION} AND NOT DEFINED ${CMAKE_WINDOWS_KITS_10_DIR})
        ...
        set(WINDOW_SDK_PATH_FILE "${WIN_CAMERA_ROOT_PATH}/config/window_sdk_path.txt")
    ...
    if (NOT DEFINED CMAKE_WINDOWS_KITS_10_DIR)
        message("Window SDK Path not found. Please set the absolute path in the ${WIN_CAMERA_ROOT_PATH}/config/window_sdk_path.txt or add a argument: cmake -DCMAKE_WINDOWS_KITS_10_DIR=Your/Window10SDK/Absolute/Path")
    endif()
