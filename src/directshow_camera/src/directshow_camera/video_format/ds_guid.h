...
#pragma once
#ifndef DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__VIDEO_FORMAT__DIRECTSHOW_GUID_H
#define DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__VIDEO_FORMAT__DIRECTSHOW_GUID_H
