...
#pragma once
#ifndef DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__UTILS__DIRECTSHOW_VIDEO_FORMAT_UTILS_H
#define DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__UTILS__DIRECTSHOW_VIDEO_FORMAT_UTILS_H
