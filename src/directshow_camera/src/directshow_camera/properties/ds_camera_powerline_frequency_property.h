...
#pragma once
#ifndef DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__PROPERTIES__DIRECTSHOW_CAMERA_POWERLINE_FREQUENCY_PROPERTY_H
#define DIRECTSHOW_CAMERA__DIRECTSHOW_CAMERA__PROPERTIES__DIRECTSHOW_CAMERA_POWERLINE_FREQUENCY_PROPERTY_H
