...
#pragma once
#ifndef DIRECTSHOW_CAMERA__CAMERA__PROPERTIES__CAMERA_PROPERTY_PAN_H
#define DIRECTSHOW_CAMERA__CAMERA__PROPERTIES__CAMERA_PROPERTY_PAN_H
...
{
    class CameraPropertyPan : public CameraProperty
    {
    public:
        CameraPropertyPan(
            const Camera& camera,
