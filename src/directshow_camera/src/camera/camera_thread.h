...
#pragma once
#ifndef DIRECTSHOW_CAMERA__CAMERA__CAMERA_THREAD_H
#define DIRECTSHOW_CAMERA__CAMERA__CAMERA_THREAD_H
...
{
    /**
     * @brief A Thread for Camera to continuously capture images.
     * 
     */
    class CameraThread {
    public:
...
#pragma region Constructor and Destructor
        ...
        */
        CameraThread(std::shared_ptr<Camera>& camera);
